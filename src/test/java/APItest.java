...
public class APItest {
    ...
    void TC001() throws IOException {
        ...
        FileWriter fileWriter = new FileWriter("src/test/resources/response.json");
        Response response = RestAssured.get("https://api.github.com/repos/metrolab/SingleDateAndTimePicker");
